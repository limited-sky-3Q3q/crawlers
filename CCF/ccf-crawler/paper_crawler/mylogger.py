...
def __init():
	...
	debug_file_handle = RotatingFileHandler(filename=os.path.join(LOG_FOLDER, 'log'),
	                                        maxBytes=1024*1024, backupCount=20, encoding='utf-8')
	...
	warning_file_handle = RotatingFileHandler(filename=os.path.join(LOG_FOLDER, 'warning'),
	                                          maxBytes=1024*1024, backupCount=20, encoding='utf-8')
	...
	error_file_handle = RotatingFileHandler(filename=os.path.join(LOG_FOLDER, 'error'),
	                                             maxBytes=1024*1024, backupCount=20, encoding='utf-8')
	error_file_handle.setLevel(ERROR)
	error_file_handle.setFormatter(DEFAULT_FILEHANDLER_FORMATTER)
	root.addHandler(error_file_handle)
